...
updated_items = update_stock("P002",100)
updated_items = update_stock("P003",13)
updated_items = update_stock("P004",2)"""
...
csv_file_name = "stocks_more_than_30.csv"

fieldnames = ["stock less than 30"]

try:
    with open(csv_file_name, mode='w', newline='') as csv_file:
        
        writer = csv.writer(csv_file)
        writer.writerow(["stock less than 30"])  # header
